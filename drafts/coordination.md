...
|---|---|---|---|---|
| overhaul-v2 | `feat/ui-overhaul-v2` | `~/OpenDrone-Web-wt/overhaul-v2` | 3006 | Draft PR #285 (TITLE BLOCK re-skin). Rebased onto main through #306 (2026-07-17): #301 donation removal, #302 reviews, #303 analytics, #304 ShopPay + derived stack copy all preserved under the re-skin. First review feedback applied (2026-07-17): locale-prefixed Shopify menu URLs no longer leak Home/Catalog/Contact into the desktop nav, and the PDP buy column got a breathing-room pass (spec cells on the selected tier only, 2x2 ladder, grouped rhythm). Awaiting Stan's visual review. Review note: the branch's homepage header shows a teal "incutec" wordmark with a "Who's incutec?" tag; confirm intentional. |
