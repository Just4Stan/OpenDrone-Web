...
export type SupportCustomerPrefillQuery = {
  customer: Pick<
    CustomerAccountAPI.Customer,
    'id' | 'firstName' | 'lastName'
  > & {
...
export type SupportCustomerIdQueryVariables = CustomerAccountAPI.Exact<{
  [key: string]: never;
}>;

export type SupportCustomerIdQuery = {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query SupportCustomerId {\n    customer {\n      id\n    }\n  }\n': {
    return: SupportCustomerIdQuery;
    variables: SupportCustomerIdQueryVariables;
  };
}
