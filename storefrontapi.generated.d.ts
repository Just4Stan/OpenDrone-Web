...
export type HeaderProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type HeaderProductsQuery = {
  products: {
    nodes: Array<
    ...
    articles: {
      nodes: Array<
        Pick<
          ...
          'handle' | 'title' | 'publishedAt' | 'excerpt' | 'contentHtml'
        >
      >;
    };
  }>;
...
export type CatalogSiteSearchQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
...
export type CatalogSiteSearchQuery = {
  articles: {
    nodes: Array<
...
> & {
  ...
  reviewsRatingCount?: StorefrontAPI.Maybe<
...
export type BundleComponentQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type BundleComponentQuery = {
  product?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CatalogSiteSearch(\n    $country: CountryCode\n    $language: LanguageCode\n    $term: String!\n    $first: Int\n  ) @inContext(country: $country, language: $language) {\n    articles: search(query: $term, types: [ARTICLE], first: $first) {\n      nodes {\n        ... on Article {\n          __typename\n          handle\n          id\n          title\n          trackingParameters\n          blog {\n            handle\n          }\n        }\n      }\n    }\n    pages: search(query: $term, types: [PAGE], first: $first) {\n      nodes {\n        ... on Page {\n          __typename\n          handle\n          id\n          title\n          trackingParameters\n        }\n      }\n    }\n  }\n': {
    return: CatalogSiteSearchQuery;
    variables: CatalogSiteSearchQueryVariables;
  };
  ...
  '#graphql\n  query BundleComponent(\n    $country: CountryCode\n    $language: LanguageCode\n    $handle: String!\n  ) @inContext(country: $country, language: $language) {\n    product(handle: $handle) {\n      handle\n      title\n      variants(first: 20) {\n        nodes {\n          id\n          sku\n          availableForSale\n          price {\n            amount\n            currencyCode\n          }\n          selectedOptions {\n            name\n            value\n          }\n        }\n      }\n    }\n  }\n': {
    ...
    variables: BundleComponentQueryVariables;
  };
