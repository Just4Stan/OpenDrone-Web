...
import type {Route} from './+types/end-use';
...
export const meta: Route.MetaFunction = ({data}) => {
  ...
  const labels = legalLabels('end-use', locale);
  return buildSeoMeta({
    title: labels.title,
...
export async function loader({request}: Route.LoaderArgs) {
  return resolveLegalLoader(request, 'end-use-policy', 'end-use');
}

export default function EndUseRoute() {
