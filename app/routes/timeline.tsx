...
const TIMELINE: TimelineEvent[] = [
  {date: '2026-03-09', title: 'OpenESC 20×20: first commit', detail: 'The project starts as one 4-in-1 ESC design.', tag: 'esc', kind: 'commit', url: 'https://github.com/incutec-hw/OpenESC-20x20/commits/main'},
  ...
  {date: '2026-03-16', title: 'First production files exported', detail: '20×20 V1 and 30×30 V0.1 gerbers, BOM and placement.', tag: 'esc', kind: 'order', url: 'https://github.com/incutec-hw/OpenESC-20x20'},
  ...
  {date: '2026-07-25', title: 'External contributor proposes a full 20×20 rework', detail: 'Issue #8: exactly the kind of contribution the license invites.', tag: 'esc', kind: 'upstream', url: 'https://github.com/incutec-hw/OpenESC-20x20/issues/8'},
