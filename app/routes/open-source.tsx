    ...
    <div className="editorial-page">
      ...
      <section className="editorial-section">
        ...
        <p>
          ...
          the QC time, the packaging, the courier, the VAT, support, and the
          next revision&apos;s engineering time.
        </p>
      </section>
      ...
      <section className="editorial-section">
        ...
        <p>
          Four revenue lines, in rough order of expected size: retail margin on
          the boards we make, volume orders from schools and teams, paid
          consulting on custom variants, and the firmware split: €1 per unit
          forwarded to the upstream firmware project the board runs. That last line exists because
        ...
        <p>
          ...
          keys. The site&apos;s analytics are cookieless (Plausible) and the product
          works without the web store existing.
        </p>
      </section>
