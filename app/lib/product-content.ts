...
export type ProductContent = {
   ...
   *  is the Shopify option NAME that carries the line's variants (e.g.
   *  "Model", "Mount"); `variants` is keyed by the option VALUE. See
   *  {@link VariantContent}. */
  optionAxis?: string;
...
export const PRODUCT_CONTENT: Record<string, ProductContent> = {
  openesc: {
    ...
    inTheBox: [
      {qty: '1×', item: 'OpenESC 4-in-1 board', note: 'mount selected at checkout'},
