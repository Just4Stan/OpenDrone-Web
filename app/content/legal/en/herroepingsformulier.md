...
8. The product must be returned in its original condition. A reduction in value due to use beyond what is necessary to establish the nature, characteristics and functioning of the product may be deducted. For electronics components, soldering, mounting, connecting power and flight use go beyond that assessment (see Terms and Conditions Art. 5.8).
